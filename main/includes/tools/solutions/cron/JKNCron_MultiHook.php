...
/**
 * A MultiHook implementation that assumes an object instance.
 */
trait JKNCron_MultiHook {
	use JKNCron;
	 ...
	 */
	abstract function activate_cron(): void;

	/**
	 * (Override) Unschedule due to deactivation.
	 */
	abstract function deactivate_cron(): void;
}
